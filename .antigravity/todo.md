...
- [ ] Verify the v2.5 joiner system teleport sequence with native dynamic yielding (RemoteFunction & ConfirmationPrompt UI yielding) across server hops and rejoins.
