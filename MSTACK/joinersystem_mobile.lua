...
-- local VirtualInputManager = game:GetService("VirtualInputManager") -- DISABLED FOR MOBILE SAFETY
...
local qot = nil -- DISABLED FOR MOBILE SAFETY: queue_on_teleport or (syn and syn.queue_on_teleport) or (fluxus and fluxus.queue_on_teleport)
