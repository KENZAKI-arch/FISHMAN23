...
getgenv().MACRO_WAYPOINTS = {
    ...
    { Pos = Vector3.new(5102, 2307, -20792), Action = "ROOM_ROUNDUP" }, -- clear room before lever appears
    ...
    { Pos = Vector3.new(4802, 2307, -20757), Action = "ROOM_ROUNDUP" }, -- clear room 
    ...
    { Pos = Vector3.new(4794, 2400, -20828), Action = "ROOM_ROUNDUP" }, -- boss fight
    { Pos = Vector3.new(5063, 2398, -20805), Action = "ROOM_ROUNDUP" }, -- go here clear room
    { Pos = Vector3.new(5552, 2406, -20833), Action = "ROOM_ROUNDUP" }, -- go here clear room again
    { Pos = Vector3.new(5696, 2444, -20799), Action = "NAVIGATE" }, -- stairway checkpoint
    { Pos = Vector3.new(5603, 2500, -20964), Action = "ROOM_ROUNDUP" }, -- stairway room clear
